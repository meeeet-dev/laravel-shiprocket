...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/meeeet-dev/laravel-shiprocket.svg?style=flat-square)](https://packagist.org/packages/meeeet-dev/laravel-shiprocket)
![Psalm](https://github.com/meeeet-dev/laravel-shiprocket/workflows/Psalm/badge.svg?branch=master)
[![Total Downloads](https://img.shields.io/packagist/dt/meeeet-dev/laravel-shiprocket.svg?style=flat-square)](https://packagist.org/packages/meeeet-dev/laravel-shiprocket)
![Tests](https://github.com/meeeet-dev/laravel-shiprocket/workflows/Tests/badge.svg?branch=master)
...
2. [Usage](https://github.com/meeeet-dev/laravel-shiprocket#installation)
    ...
    9. [Warehouse](https://github.com/meeeet-dev/laravel-shiprocket#Warehouse)
